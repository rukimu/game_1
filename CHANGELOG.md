...
- **43-a**: 巨漢 / 隻腕 / 双子 戦士 (3 職 30 skills)
- **43-b**: 元踊り子 / 元医者 / 元囚人 戦士 (3 職 30 skills)
- **43-c**: 雪国 / 海賊崩れ / 元騎士団長 (3 職 30 skills)
- **43-d**: 退役老兵 / 元獣狩り / 元密漁者 (3 職 30 skills)
- 各職 SKILL_DESIGN.md §1 の 10 役割枠 (基本攻撃 / 必殺技 / 自バフ / 敵デバフ / 仲間援護 / AOE / 持続バフ / 連携 / 究極 / signature) を網羅
- 各職 baseStats.mp を 18 (一般職) / 22 (legendary 元騎士団長) に底上げ (10 スキル運用に必要)
- 既存 C31 スキル 12 個は seed の `findFirst by name` skip で名前一致保持、新規 108 skill のみ create
- 触ったファイル: `prisma/curatedJobs.ts` (12 entries × ~100 行 = ~1200 行追加)
