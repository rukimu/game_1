...
- [x] **50-c**: 風使い / 水脈読み / 竜眼 各 10 スキル (= 30) 設計
- [x] **50-d**: 妖精郷育ち / 不死者血族 / 彗星使者 各 10 スキル (= 30) 設計
- [x] 既存 12 rare スキル全て seed name skip で保持。新規 108 skill create
- [x] **★ Phase 2 完走**: 累計 1,000 unique skills 全手作り達成 (curated 100 職 × 10 = 1,000)
- [x] 監督方針 Q2 「全手作り」完遂

### Cycle 49 (2026-05-03) — Phase 2 heretic 12 職 × 10 スキル = 120
- [x] **49-a**: 禁書館の番人 / 元神官 / 双頭異端 各 10 スキル (= 30) 設計
- [x] **49-b**: 不死研究 / 言語学者 / 解剖学者 各 10 スキル (= 30) 設計
- [x] **49-c**: 元盗賊王 / 言葉狂い / 異界帰還 各 10 スキル (= 30) 設計
- [x] **49-d**: 影使い / 自閉派 / 元魔導院追放 各 10 スキル (= 30) 設計
- [x] 既存 12 heretic スキル全て seed name skip で保持。新規 108 skill create
- [x] 累計 880 unique skills、Phase 2 残り 12 職 × 10 = 120 (rare、Cycle 50 で完走予定)

### Cycle 48 (2026-05-03) — Phase 2 support 12 職 × 10 スキル = 120
- [x] **48-a**: 旅芸人 / 子守歌 / 賭博師 各 10 スキル (= 30) 設計
- [x] **48-b**: 占い師 / 通訳 / 動物使い 各 10 スキル (= 30) 設計
- [x] **48-c**: 観光案内 / 葬儀 / 産婆 各 10 スキル (= 30) 設計
- [x] **48-d**: 公証人 / 仲介屋 / 酔いどれ 各 10 スキル (= 30) 設計
- [x] 既存 12 support スキル全て seed name skip で保持。新規 108 skill create
- [x] 累計 760 unique skills、Phase 2 残り 24 職 × 10 = 240
