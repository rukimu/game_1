...
| F. やりこみ・エンドゲーム | ★★★☆☆ | ★★★★★ | C28 (mid-game), C30 (skill inherit), C36 (endless) |
| G. 公平・経済 | ★★★★☆ | ★★★★★ | C37 (rate-limit, monitoring) |
| H. UX・プレゼン | ★★☆☆☆ | ★★★★★ | C27 (TOP5), C35 (pixel art), C38 (a11y) |
...
### Cycle 28 — 中盤の離脱要因を全消し（Lv30-45 の密度を上げる）

**狙い**: README に明記されてる「Lv30+ の中盤コンテンツ密度不足」を埋める。

1. **中盤限定の専用ダンジョン 5 種**
   - 「忘却の図書館」「霜帝の塔」「鏡映の湖底」「灰の唄の祭壇」「鐘塔の地下」
   - Lv25-45 推奨、各テーマ別の固有敵 / 固有ボス / 固有装備プール
2. **週次レイドダンジョン**（パーティ4-10人推奨）
   - 5 階構成、最終ボスは tier 別装備確定ドロップ
3. **Mastery クエスト**
   - 各職に固有「修練クエスト」3 段階（敵を 50 体、街を 5 つ、特定スキル使用 100 回 等）
   - クリアで職固有称号 + マスタリ stat ボーナス
4. **クエスト多様化フェーズ 2**
   - 「護衛」「奪還」「謎掛け（謎のヒント収集）」追加
5. **Daily チャレンジ**
   - 毎日 3 つランダム生成（全クリで bonus 報酬）
